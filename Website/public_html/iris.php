...
require_once __DIR__ . '/../required/db_connect.php';
	...
	$sql = "SELECT * FROM log WHERE msgID=9";
...
<html>
	...
	<div class="icon-bar">
	  ...
	  <a class="active" href="#"><i class="fa fa-eye"></i></a> 
			...
			<script>
				...
				$(document).ready(function() { //once the page is ready, runs the code
					setInterval(function() { //calls the function to be executed
						$('#active').load('iris_log.php') //loads info from DBpeople.php into this DIV
